...
export default function AskMultiplexPage() {
  return (
    <main>
      {/* ── Hero ── */}
      <section className="relative bg-fort-charcoal pt-36 pb-24 md:pt-44 md:pb-32 overflow-hidden">
        <div
          aria-hidden="true"
        ...
        <div className="relative max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <div className="w-16 h-[3px] bg-fort-gold mx-auto mb-8" />
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-[0.2em] bg-fort-gold/10 text-fort-gold border border-fort-gold/20 mb-8">
            Now in Early Access
          </span>
          <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl text-white leading-[1.1] tracking-tight max-w-3xl mx-auto">
            Know If Your Multiplex Deal Works
            <span className="block text-fort-gold">Before You Build</span>
          </h1>
          <p className="font-sans text-gray-300 mt-8 max-w-xl mx-auto text-lg leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <FadeIn>
            <div className="text-center mb-16">
              ...
              <p className="font-sans text-fort-gray mt-4 max-w-xl mx-auto">
                AskMultiPlex covers every module a professional developer runs through before
                committing to a project.
              </p>
            </div>
          </FadeIn>
          <FadeInGroup className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map(({ icon, title, body }) => (
              <div
                key={title}
                className="group relative bg-white rounded-xl p-7 border border-fort-charcoal/5 hover:border-fort-gold/30 hover:shadow-lg transition-all duration-300"
              >
                <div className="absolute top-0 left-8 w-12 h-[3px] bg-fort-gold rounded-b" />
                <div className="text-fort-gold mt-4 mb-4">{icon}</div>
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <FadeInGroup className="grid sm:grid-cols-3 gap-6 mt-12 text-center">
            {[
              ...
              <div key={stat} className="bg-white rounded-xl p-8 border border-fort-charcoal/5 hover:border-fort-gold/30 hover:shadow-lg transition-all duration-300">
      ...
      <section className="bg-white py-24 md:py-32">
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <FadeInGroup className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={who} className="group relative rounded-xl border border-fort-charcoal/5 p-6 bg-fort-bg hover:border-fort-gold/30 hover:shadow-lg transition-all duration-300">
      ...
      {/* ── CTA / Early access ── */}
      <section id="get-access" className="relative bg-fort-charcoal py-24 md:py-32 overflow-hidden">
        <div
          aria-hidden="true"
          className="absolute inset-0 opacity-[0.03]"
          style={{
